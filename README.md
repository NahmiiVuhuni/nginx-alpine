...
This is an Nginx container running on Alpine built from source, with all first-party modules except Google Performance tools, and with naxsi and nginx-dav-ext-module.
```
nginx -V
