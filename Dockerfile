...
RUN apk -U upgrade \
 ...
 #--with-cc-opt="-Os -D_FORTIFY_SOURCE=2 -D_GLIBCXX_ASSERTIONS -fasynchronous-unwind-tables -fexceptions -fpie -Wl,-pie -fpic -shared -fplugin=annobin -fstack-clash-protection -fstack-protector-all -fstack-protector-strong -mcet -fcf-protection -pipe -Wall -Werror=format-security -Werror=implicit-function-declaration -Wl,-z,defs -Wl,-z,now -Wl,-z,relro" \
 && make \
 && make install \
